...
<div class="main_wrap">
	<main class="main">
        ...
        <div class="page-course">
          ...
          <div class="page-course__table page-course__table--2col">
            ...
            <div class="page-course__item">¥8,800</div>
        ...
        <p>楽譜の読み方から丁寧にご説明いたします。初心者から経験者までどなたでも大歓迎です。</p>
        <div class="page-course">
          <div class="page-course__title">
            １レッスン 30分 / 年間44回<span>(月3〜４回 レッスン)</span>
          </div>
          <div class="page-course__table page-course__table--3col">
            <div class="page-course__item page-course__label">コース名</div>
            <div class="page-course__item page-course__label">料金</div>
        ...
        <div class="page-course">
          ...
          <div class="page-course__table page-course__table--3col">
            ...
            <div class="page-course__item page-course__label">料金</div>
            <div class="page-course__item page-course__label">内容</div>
            <div class="page-course__item">マスターコース</div>
            <div class="page-course__item">¥22,000</div>
        ...
        <br>
        <br>
        <p>レッスンについてのご相談はお気軽に<a href="https://forms.gle/hYhretfVKwrViTqp9" target="_blank">お問い合わせ</a>ください。</p>
			</div>
		</div>

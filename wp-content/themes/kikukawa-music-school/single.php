	...
	<main class="main">
		<div class="post__body">
			<div class="post__header">
				<div class="post__date"><?php echo get_the_date('Y.m.d'); ?></div>
		...
		<div class="pagination">
			...
			<div class="pagination__item pagination__prev arrow"><?php previous_post_link('%link', '前のページ'); ?></div>
			<div class="pagination__item pagination__next arrow"><?php next_post_link('%link', '次のページ'); ?></div>
		</div>
